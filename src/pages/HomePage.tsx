...
import { establishedBusinesses, developmentProjects, companyAboutText, heroFarmlandImg } from '../data/companyData';
    ...
    <div className="space-y-20 pb-16 animate-fadeIn">
      ...
      <section className="relative min-h-[85vh] lg:min-h-[88vh] flex items-center justify-center bg-stone-950 text-white overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src={heroFarmlandImg}
            alt="South African Farmland & Agriculture"
            referrerPolicy="no-referrer"
            className="w-full h-full object-cover opacity-35 scale-105 transition-transform duration-1000"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#09261d] via-[#0f382c]/80 to-stone-950/70" />
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 pb-4 border-b border-stone-200">
          ...
          >
            <span>View All 7 Businesses</span>
